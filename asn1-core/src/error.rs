...
impl Error {
    ...
    pub fn classify(&self) -> Category {
        match *self.0 {
            Inner::Message(_) => Category::Data,

            Inner::Io(_) => Category::Io,

            Inner::EofWhileParsingPrimitive | Inner::EofWhileParsingConstruction => Category::Eof,

            Inner::RecursionLimitExceeded => Category::Syntax,
        }
    }
